        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
          <div className="flex items-center">
            ...
            <div className="flex-shrink-0 items-center">
              <span className="text-white text-lg font-semibold sm:text-center">Frank Muthomi</span>
            </div>
          </div>
            ...
            {navigation.map((item) => (
              <ScrollLink
                ...
                className={classNames(
                  ...
                  item.current ? 'text-white bg-gray-900' : 'text-gray-300 hover:bg-gray-700 hover:text-white cursor-pointer'
                )}
                activeClass="text-white"
                onClick={handleLinkClick(item.to)}
              >
